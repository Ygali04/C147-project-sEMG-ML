...
Three hardware environments were used: a local workstation (1×RTX 5070 Ti, 150 epochs each) and a
cloud instance (8×H200 Verda, one experiment per GPU) and another cloud instance (Nvidia T4).
...
| BiGRU                          | -      | -           | 17.27%       | 83.79%   | 0.638     | 4.252      | 126/150                                                            | Test and Validation very wide gap |
